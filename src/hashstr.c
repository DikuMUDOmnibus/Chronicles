 ...
 ***************************************************************************
 * - Advanced string hashing module by Derek Snider                        *
 ***************************************************************************
 * These functions keep track of how many "links" are pointing to the      *
 * memory allocated, and will free the memory if all links are removed.    *
 ...
 * and any free/DISPOSE used on the same pointer should be replaced with   *
